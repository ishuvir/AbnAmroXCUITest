...
#import "SessionAccessibilityStatus.h"
...
/**
 The result status.
 */
@property (assign, nonatomic) TestResultStatus status;
...
@property (readonly, nonatomic) SessionAccessibilityStatus *accessibilityStatus;
